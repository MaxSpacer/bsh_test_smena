...
$(document).ready(function() {
    ...
    //   $(this+'.djn-items').toggleClass("collapsed-pressed"); //you can list several class names
    //   e.preventDefault();
    // });
    // $( 'h2 + *' ).hide();
	// $( 'h2' ).click( function() {
	// 	$( this ).next("table").toggleClass("collapsed-pressed"); //you can list several class names
	// 	// return false;
	// } );
// </script>
