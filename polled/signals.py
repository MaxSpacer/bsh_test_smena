...
@receiver(post_save, sender=PolledItemList)
def update_bal_polled_item_list(sender, instance, created, **kwargs):
    # polled = instance.polled
    # pil = PolledItemList.objects.filter(polled=polled)
    # qty_pils = pil.count()
    # print('qty_pils')
    # print(qty_pils)
    # percent_on_quest = 100/qty_pils
    # print('percent_on_quest')
    # print(percent_on_quest)
    # global_total_bal = 0
    # for p in pil:
    ...
    #     print(g)
    #     global_total_bal += g
    #     # print(global_total_bal)
    # print('global_total_bal')
    # print(global_total_bal)
    # polled.polled_total_perc = global_total_bal
    # polled.save()
    # print(polled.polled_total_perc)

    # polled.polled_total_perc = 0
